...
<template>
	<section>
        ...
        <p v-if="item.frontmatter.excerpt ?  item.frontmatter.excerpt : item.frontmatter.description">{{ item.frontmatter.excerpt ?  item.frontmatter.excerpt : item.frontmatter.description }}</p>
