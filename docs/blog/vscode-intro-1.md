...
type: post
blog: true
excerpt: vscode 是一款优秀的开源编辑器，从代码复杂度和架构层面，无疑是 web 前端领域最值得学习和研究的目标之一。通过开源代码，我们可以看到，如何组织上百万的代码量，保证开发效率和可扩展性。
tags:
    - web
    - vscode
    - 开源
...
vscode 是一款优秀的开源编辑器，从代码复杂度和架构层面，无疑是 web 前端领域最值得学习和研究的目标之一。通过开源代码，我们可以看到，如何组织上百万的代码量，保证开发效率和可扩展性。
...
通常大型前端项目，从可维护性的角度会划分比较清晰的层级，并试图通过某种形式对核心模块进行隔离，以减少变化业务对稳定性的破坏。vscode 这种灵活的架构可以很方便的进化和扩展，但对开发者来说要求更高，必须更全面的熟悉整体模块。
