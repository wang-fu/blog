...
![](../assets/2022-08-25-10-58-53.png)
...
![](../assets/2022-08-25-16-19-02.png)
...
我们从设计 hook 的背景，已经知道带状态逻辑复用确实是前端（仅 vue/react）痛点，hook 非常适合小规模状态提取出来取代传统小类。
