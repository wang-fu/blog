...
## 前言
上次我们解释了为什么 vscode 这种大型项目设计依赖注入管理海量的模块有什么好处。也提到了 DI 必须有这样一种机制：
...
[参数装饰器](https://www.tslang.cn/docs/handbook/decorators.html)声明在一个参数声明之前（紧靠着参数声明）。 参数装饰器应用于类构造函数或方法声明。
...
![](/docs/assets/2022-05-14-16-06-23.png)

## 依赖注入的具体实现

好了，让我们开始实现一个简单依赖注入模型。主要三个过程，依赖收集，依赖储存，最后依赖消费——即自动注入依赖的环节。

![](/docs/assets/2022-05-14-16-12-18.png)
#### 依赖储存
...
![](/docs/assets/2022-05-14-16-35-20.png)
...
![](/docs/assets/2022-05-14-11-46-08.png)
...
![](/docs/assets/2022-05-14-18-14-00.png)
