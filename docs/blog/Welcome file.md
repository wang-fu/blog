...
![输入图片说明](assets/imgs/2024-05-25/lOLCH7aZfdckDWXG.png)

## 创建文件和文件夹

使用导航栏左边的文件夹图标可以访问文件资源管理器。您可以通过单击文件资源管理器中的 **创建文件** 图标来创建新文件。您还可以通过单击 **创建文件夹** 图标来创建文件夹

![输入图片说明](docss/assets/imgs/2024-05-25/AUQKlGNrOePE54Ek.png)
...
## 重命名文件
![输入图片说明](/docs/assets/imgs/2024-05-25/5HYxUyM6OJzfoVq1.png)
输入图片说明
您可以通过单击导航栏中的文件名或单文件资源管理器中的**重命名**图标来重命名当前文件。
~~删除线文本~~
## 搜索文件

![输入图片说明](assets/imgs/2024-05-25/x4Yt4MjtS1xqa4RK.png)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzkwMjc3NSwtMjEwMDIyNDQ4LC01NTE4Mj
Q4NjEsLTY5MTEzMzQ5MSw2NjkwNTI1NzYsLTEzODMzNjc2NSwt
MTk4ODQzMzM5Nyw4NTUyMDgzMTRdfQ==
-->